...
def AssistanceCheck(command):
    return command == Actions.HELP or command == Actions.CODE or command == Actions.ID or command == Actions.HOWTO or command == Actions.LOCATION or command == Actions.LIST or command == Actions.PUSH
