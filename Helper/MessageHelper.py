...
class MessageHelper:
    ...
    def ConstructFoodList(self, foodList):
        ...
        for food in foodList:
            ...
            self.Add(str(count) + ". " + added_food.GetItem() + " 位於 " + added_food.GetLocation() + " 將於 " + added_food.GetDate() + "過期\n")
            count = count + 1
    ...
    def ConstructTheDayFood(self, id, foodList):
        ...
        for food in foodList:
            ...
            self.Add(str(count) + ". " + alert_food.GetItem() + " 位於 " + alert_food.GetLocation()+"\n")
            count = count + 1
    ...
    def ConstructThreeDaysFood(self, foodList):
        ...
        for food in foodList:
            alert_food = Food(food['item'], food['date'], food['location'])
            self.Add(str(count) + ". " + alert_food.GetItem() + " 位於 " + alert_food.GetLocation() + " 將於 " + alert_food.GetDate() + "過期\n")
            count = count + 1
